		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#appsdflccustomerregistrationts-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"appsdflccustomerregistrationts-display": {
								"semanticObject": "appsdflccustomerregistrationts",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=apps.dflc.customerregistrationts",
									"url": sap.ui.require.toUrl("apps/dflc/customerregistrationts")
								}
							}
						}
					}
