		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#appsdflccustomerregistration-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"appsdflccustomerregistration-display": {
								"semanticObject": "appsdflccustomerregistration",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=apps.dflc.customerregistration",
									"url": sap.ui.require.toUrl("apps/dflc/customerregistration")
								}
							}
						}
					}
